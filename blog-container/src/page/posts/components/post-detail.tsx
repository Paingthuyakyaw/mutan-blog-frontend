  ...
  return (
    <div className=" pt-5 max-w-full container">
      ...
      <div className=" max-w-full container max-[600px]:mt-5 lg:mt-10 xl:mt-10 2xl:mt-10 md:mt-10">
        <div className=" uppercase space-x-3 max-[600px]:text-[10px] md:text-sm tracking-widest font-thin text-gray-500">
        ...
        <div className=" text-justify mt-5 space-y-5 max-[600px]:text-sm font-thin text-black/60 ">
